...
export interface FileBrowserHandle {
	...
	/**
	 * Method used to programatically trigger file actions in Fb.
...
export type FbActionUnion = (typeof FbActions)[keyof typeof FbActions];
...
export interface FileBrowserProps {
	/**
	 * An ID used to identify this particular Fb instance. Useful when there are
	 * multiple Fb instances on the same page, and they need to interact with
	 ...
	 */
	onFileAction?: Nullable<GenericFileActionHandler<FbActionUnion>>;
