...
import { ActionGroup, FileActionMenuItem } from "./action-menus.types";
...
export type FbThunk<ReturnType = void> = ThunkAction<
  ReturnType,
  RootState,
  null,
  Action<string>
...
export type FbDispatch = ThunkDispatch<RootState, null, Action<string>>;

export type FbStore = Store<RootState>;
